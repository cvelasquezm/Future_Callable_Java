...
public class FutureFixedThreadPool {
        ...
        public static void main(String[] args) {
                ...
                try {
                        final Boolean aBoolean1 = r1.get();
                        final Boolean aBoolean2 = r2.get();
                        final Boolean aBoolean3 = r3.get();
                        final Boolean aBoolean4 = r4.get();
